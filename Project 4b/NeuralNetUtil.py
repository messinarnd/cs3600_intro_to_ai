...
def buildExamplesFromXorData(size=100):
    ...
    random.shuffle(xorDataTrainList)
    moreXorDataTrainList = xorDataTrainList * 25
    random.shuffle(moreXorDataTrainList)
    xorDataTestList = moreXorDataTrainList[80:]
    xorDataTrainList = moreXorDataTrainList[0:80]
